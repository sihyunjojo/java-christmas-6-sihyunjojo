...
class DDayDisCountPriceTest {
    ...
    void testInvalidDateUpdateDDayDisCountPrice(int day) {
        ...
        assertThrows(InvalidDateException.class, () -> DDayDisCountPrice.updateDDayDisCountPrice(inputDate));
    }
    ...
    void testUpdateDDayDisCountPrice(int day, int discountPrice) {
        ...
        Assertions.assertEquals(DDayDisCountPrice.updateDDayDisCountPrice(inputDate), discountPrice);
    }
